...
class LiSPNetx22(nn.Module):
    def __init__(self, channel=32):
        ...
        self.resnet = mit_b5()
        self.resnet_depth = mit_b5()
        self.resnet.init_weights("/home/li/桌面/kuangjia/backbone/backbone/mit_b5.pth")
        self.resnet_depth.init_weights("/home/li/桌面/kuangjia/backbone/backbone/mit_b5.pth")
        ###############################################
        # funsion encoders #
        ## rgb
        ...
        # self.BidirectionalAttention = BidirectionalAttention(256)
...
if __name__ == "__main__":
    ...
    with torch.cuda.device(0):
        ...
        print('Flops:' + flops)
        print('Params:' + params)
        c=compute_speed(net,input_size=(1, 3, 416, 416), iteration=500)
        print(c)
# print(a.shape)
# B5
# Flops:83.82 GMac
# Params:169.79 M
# =========Eval Forward Time=========
# Elapsed Time: [51.60 s / 500 iter]
# Speed Time: 103.21 ms / iter   FPS: 9.69
# (103.20998334884644, 9.688985188768338)
# Flops:33.52 GMac
# Params:190.26 M
# print(a[1].shape)
# print(a[2].shape)
